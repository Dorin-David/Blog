...
irrilevante. <br /> 
 Il nervoso Quentin Tarantino, con alle spalle ore ed ore di
...
(Enrico Ghezzi).
 <br />
Samuel Jackson, John Travolta, Bruce Willis, Uma
...
Keitel. <br />
Ciò che sorprende di Tarantino, oltre alla quasi
...
Il cinema nasce come una scoperta: si scopre che tramite un
apparecchio si riesce a “ricordare” qualcosa di “reale”, purché
questa realtà stia per un po’ di tempo <span>davanti</span> all’apparecchio: ci vuole però un attento macchinista. Così
...
tramite gli <span>attori</span> bene in vista lassù in cima, delle <span>storie </span> curate e bellissime. Tributario quindi della musica, della
...
I giornalettacci <span>pulp</span> degli anni ’30 generarono Chandler e
...
Eh, i tempi son cambiati, sono davvero cambiati, si può
